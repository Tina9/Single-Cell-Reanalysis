...
doublets_removing <- function(pbmc, doublets_path, min_feature, max_feature, mt_percent){
...
## Removing doublets
HP4540Pr <- read_data(dir_path, "HP4540Pr")
HP4540Pr <- doublets_removing(HP4540Pr, doublets_path, 200, 7500, 15)
...
HP4540Pr <- read_data(dir_path, "HP4540Pr")
HP4540Pr <- doublets_no_removing(HP4540Pr, 200, 7500, 15)
...
## Removing doublets
HP4313Pr <- read_data(dir_path, "HP4313Pr")
HP4313Pr <- doublets_removing(HP4313Pr, doublets_path, 200, 7500, 15)
...
## Do not remove doublets
HP4313Pr <- read_data(dir_path, "HP4313Pr")
HP4313Pr <- doublets_no_removing(HP4313Pr, 200, 7500, 15)
...
## Removing doublets
HP4313Re <- read_data(dir_path, "HP4313Re")
HP4313Re <- doublets_removing(HP4313Re, doublets_path, 200, 7500, 15)
...
## Do not remove doublets
HP4313Re <- read_data(dir_path, "HP4313Re")
HP4313Re <- doublets_no_removing(HP4313Re, 200, 7500, 15)
...
## Removing doublets
HP4568Pr <- read_data(dir_path, "HP4568Pr")
HP4568Pr <- doublets_removing(HP4568Pr, doublets_path, 200, 7500, 15)
...
## Do not remove doublets
HP4568Pr <- read_data(dir_path, "HP4568Pr")
HP4568Pr <- doublets_no_removing(HP4568Pr, 200, 7500, 15)
...
## Removing doublets
HP4568Re <- read_data(dir_path, "HP4568Re")
HP4568Re <- doublets_removing(HP4568Re, doublets_path, 200, 7500, 15)
...
## Do not remove doublets
HP4568Re <- read_data(dir_path, "HP4568Re")
HP4568Re <- doublets_no_removing(HP4568Re, 200, 7500, 15)
