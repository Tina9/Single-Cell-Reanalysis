...
HP4540Pr <- doublets_removing(HP4540Pr, doublets_path, 200, 7000, 25)
...
HP4313Pr <- doublets_removing(HP4313Pr, doublets_path, 200, 9500, 25)
...
HP4313Re <- doublets_removing(HP4313Re, doublets_path, 200, 9000, 25)
...
HP4568Pr <- doublets_removing(HP4568Pr, doublets_path, 200, 9500, 25)
...
HP4568Re <- doublets_removing(HP4568Re, doublets_path, 200, 8500, 25)
